...
export function ShowcasePage() {
  ...
  return (
    <PageContainer>
      <PageHeader title="Public Showcase" description="Feature inventions, projects, research, documents, certificates, achievements, and portfolio work." action={isApprovedMember ? <Button onClick={() => setFormOpen(true)}><Plus className="mr-2 h-4 w-4" />Showcase Work</Button> : null} />
