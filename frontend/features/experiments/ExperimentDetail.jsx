...
import { ExperimentsService } from '@services/firestore/experiments';
import { EXPERIMENT_CATEGORIES, EXPERIMENT_DIFFICULTIES, EXPERIMENT_STATUSES } from '@services/firestore/experiments';
...
export default function ExperimentDetail() {
  ...
  const handleWorkspaceAction = async () => {
    ...
    setSaving(true);
    try {
       const newWs = await import('@services/firestore/workspace').then(m => m.WorkspaceService.createWorkspace({
