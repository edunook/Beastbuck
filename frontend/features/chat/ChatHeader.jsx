...
export function ChatHeader({
  ...
  return (
    <header className="relative z-30 flex flex-col border-b border-white/10 bg-zinc-950/95 backdrop-blur-2xl shrink-0">
      ...
      <div className="flex items-center justify-between px-3 sm:px-5 py-2.5 sm:py-3 gap-2 min-h-[56px]">
        ...
        <div className="flex items-center gap-2 sm:gap-2.5 min-w-0">
          <div className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border ${
            isAnnouncement
              ? 'bg-amber-500/15 border-amber-500/30 text-amber-300 shadow-lg shadow-amber-950/30'
              : 'bg-cyan-500/15 border-cyan-500/30 text-cyan-300 shadow-lg shadow-cyan-950/30'
          }`}>
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <span className="hidden min-[380px]:inline-flex items-center gap-1 rounded-full bg-emerald-500/15 border border-emerald-500/30 px-2 py-0.5 text-[9px] font-bold text-emerald-300 shrink-0">
                <span className="h-1.5 w-1.5 rounded-full bg-emerald-400 animate-pulse" />
                Live
              </span>
            </div>
            <p className="text-[11px] text-white/50 truncate max-w-[145px] min-[380px]:max-w-[190px] sm:max-w-xs md:max-w-md">
              {roomDescription}
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1 sm:gap-1.5 shrink-0">
          {onShowGames && (
            <button
              type="button"
              onClick={onShowGames}
              className="hidden min-[420px]:flex h-8 sm:h-9 items-center justify-center gap-1.5 rounded-xl border border-cyan-500/30 bg-cyan-500/10 px-2 sm:px-3 text-cyan-200 transition hover:bg-cyan-500/20 hover:text-white active:scale-95 text-xs font-bold"
          ...
          {onShowSettings && (
            <button 
              type="button"
              onClick={onShowSettings}
              className="hidden sm:flex h-9 w-9 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-white/70 hover:bg-white/10 hover:text-cyan-200 transition active:scale-95"
        ...
        <div className="px-3 sm:px-5 pb-2.5 pt-1 border-t border-white/5 animate-fade-in">
          <div className="relative">
            ...
            <input
              ...
              autoFocus
              className="w-full rounded-xl border border-cyan-500/30 bg-black/40 pl-9 pr-8 py-2 text-sm text-white outline-none placeholder:text-white/40 focus:border-cyan-300 focus:bg-black/60 transition"
            />
            {searchQuery && (
              <button
                type="button"
